    ...
    if lootlist[text] then
        ...
        addonData.callback(1, function()
            ...
            if lootlist[text] > 1 then
                lootlistMap[creatureGuid] = { player = "mehrere Spieler", loot = {} }
...
function events:UPDATE_MOUSEOVER_UNIT()
    ...
    if next(lootlistMap[unitGuid].loot) then
        ...
        if hasLoot then
            table.foreach(lootlistMap[unitGuid].loot, function (k, v)
...
local blackList =
{
	...
	1978, 13549, 13551, 13552, 13553, 13554, 13555, 25295, --serpentsting
	5570, 24974, 24975, 24976, 24977, --insect swarm
	16511, 17347, 17348, --hemorrhage
	8921, 8924, 9835, 9834, 8926, 8925, 8928, 8927, 9833, 8929, --moonfire
	12294, 21551, 21552, 21553, --mortal strike
	-- 15286, --vampiric embrace
	3034, 14279, 14280, --viper sting
	3043, 14277, 14276, 14275, --scorpid sting
	2835, 2837, 11357, 11358, 25347, --deadly poison - only works when boss is targeted while poison is applied
